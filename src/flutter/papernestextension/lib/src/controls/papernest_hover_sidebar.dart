...
class PaperNestHoverSidebarControl extends StatefulWidget {
  final Control control;

  PaperNestHoverSidebarControl({Key? key, required this.control})
      : super(key: key ?? ValueKey("control_${control.id}"));

  @override
  State<PaperNestHoverSidebarControl> createState() =>
      _PaperNestHoverSidebarControlState();
}

class _PaperNestHoverSidebarControlState
    extends State<PaperNestHoverSidebarControl> {
  ...
  Future<dynamic> _invokeMethod(String name, dynamic args) async {
    switch (name) {
      ...
      case "collapse":
        ...
        return null;
      default:
        throw Exception("Unknown PaperNestHoverSidebar method: $name");
    }
  }
  ...
  int get _selectedIndex =>
      widget.control.getInt("selected_index", 0) ?? 0;
