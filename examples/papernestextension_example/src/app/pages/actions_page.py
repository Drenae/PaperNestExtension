            ...
            controls=[
                ft.ResponsiveRow(
                    ...
                    controls=[
                        PageHeader(
                            title="Actions",
                            subtitle="PaperNestButton conserve le bouton Material natif et ajoute les gradients par état, le chargement et les animations.",
                        ),
                        ft.Container(
                            col={"sm": 12, "xl": 6},
                            content=PaperNestButtonBase(page),
                        ),
                        ft.Container(
                            col={"sm": 12, "xl": 6},
                            content=PaperNestButtonGradient(page),
                        ),
                        ft.Container(
                            col={"sm": 12, "xl": 6},
                            content=PaperNestButtonAnimation(page),
                        ),
                        ft.Container(
                            col={"sm": 12, "xl": 6},
...
class PaperNestButtonBase(AppSection):
...
class PaperNestButtonGradient(AppSection):
    def __init__(self, page: ft.Page) -> None:
        self.app_page = page
...
class PaperNestButtonAnimation(AppSection):
    def __init__(self, page: ft.Page) -> None:
        self.app_page = page
...
class PaperNestButtonLoading(AppSection):
    def __init__(self, page: ft.Page) -> None:
        self.app_page = page
